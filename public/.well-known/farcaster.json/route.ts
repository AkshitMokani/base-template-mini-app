...
export async function GET() {
  try {
    const config = {
      ...
      accountAssociation: {
        header:
          "eyJmaWQiOjI1OTI1MiwidHlwZSI6ImF1dGgiLCJrZXkiOiIweDllOEI3ZDAxM0JCMDYwMjQyZDMxMTUwYzkwMEZiMzFGNDQ2ODFCODkifQ",
        payload: "eyJkb21haW4iOiJoeXBlcm1hdGNoLnZlcmNlbC5hcHAifQ",
        signature:
          "qXLDa4/L6ui037A6xo9pJJIlwipWbw7XADr5UMgXTBQijUsY8wweiAM+TtpXY0f0xWyIsG+ABROZ9vvI4anMexw=",
      },
